"""
BNCI2014_001 EEGNetECA —— 5折交叉验证（0train上CV，best模型分别在1test上评测；汇总均值±标准差）
...
from revisemodel.ecamodel import EEGNetECA
from torch.optim.lr_scheduler import StepLR

# ====================== 基本配置 ======================
device = "cuda" if torch.cuda.is_available() else "cpu"
SAVE_DIR = r"E:\wfr\code\EEG\result_eegneteca_cv5"
...
def train_one_fold(fold_id, train_idx, val_idx):
    ...
    model = EEGNetECA(n_chans=n_chans, n_outputs=n_classes, input_window_samples=n_times).to(device)
